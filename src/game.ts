...
lightningOrb.addComponent(new Transform({ position: new Vector3(0, -0.5, 0.75) }))
...
const lightningOrbSound = new Sound(new AudioClip("sounds/lightningOrb.mp3"), false)
...
const floatingWindRock = new FloatingRock(
  ...
  new Transform({ position: new Vector3(12, 2.5, 8), rotation: Quaternion.Euler(0, -90, 0) })
...
const floatingFireRock = new FloatingRock(
  ...
  new Transform({ position: new Vector3(8, 3, 12), rotation: Quaternion.Euler(0, 180, 0) })
...
const floatingWaterRock = new FloatingRock(
  ...
  new Transform({ position: new Vector3(4, 3.5, 8), rotation: Quaternion.Euler(0, 90, 0) })
)
...
const floatingEarthRock = new FloatingRock(
  ...
  new Transform({ position: new Vector3(8, 4, 4), rotation: Quaternion.Euler(0, 0, 0) })
)
